        ...
        <div className="w-90/100 h-3/5 flex justify-between gap-6 ">
            <div className="w-55/100 h-full  flex flex-col gap-6 py-2">
                ...
                <div className="w-full h-full flex flex-col ">
                    ...
                    <h5 className="text-base text-slate-300 my-3">October 2023 - December 2023</h5>
                    <span className="text-white text-base indent-6 ">I architected and implemented a schema in MongoDB, enhancing the data retrieval performance by 30%. I designed and implemented RESTful API endpoints, enabling merchants to do CRUD operations for apparel inventory, incorporating advanced search functionality with customizable filters in the Express.js framework. I optimized the integration between the backend API and the React.js frontend, and resolved some major bugs in the frontend, resulting in a 10% performance enhancement and improved user experience. Also contributed in implementing cloth segmentation, human parsing for the ML model.</span>
                    <div className="w-full h-full mt-2 flex gap-2 flex-wrap">
