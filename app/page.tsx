...
export default function Home() {
  ...
  return (
    <div className="w-screen bg-black" style={{height:'100vh '}}>
        ...
        <div className="w-full h-full px-8 md:px-20 flex flex-col justify-start items-center gap-10">
            <div className="  md:w-4/5 h-16per flex md:gap-20 gap-4">
              ...
              <div className="h-full flex flex-col justify-around py-2">
                ...
                <span className="text-white text-base md:text-xl">A mix of determination&lsquo; panic&lsquo; and a playlist for every mood swing &hellip;</span>
              </div>
            </div>
